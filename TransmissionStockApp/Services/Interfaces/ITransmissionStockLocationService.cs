...
namespace TransmissionStockApp.Services.Interfaces
{
    public interface ITransmissionStockLocationService
    {
        ...
        Task<OperationResult<bool>> UpdateQuantityAsync(int transmissionStockId, int stockLocationId, int newQuantity);
        Task<OperationResult<bool>> DeleteAsync(int transmissionStockId, int stockLocationId);
    }
